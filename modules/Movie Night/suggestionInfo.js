const { suggestionOpen, suggestionApproved, suggestionDenied, suggestionWatched } = require('../../assets/global/colors.json');
...
module.exports = {
	...
	execute: async function(client, message, args) {
		const { shinServerID, movieNightSuggestionChannelID } = client.config;
		...
		embed.addField('Message Link', `[Jump](https://discord.com/channels/${shinServerID}/${movieNightSuggestionChannelID}/${suggestion.suggestionMessageID})`);
